...
async def admins(bot, msg):
	if msg.from_user.id in SUDORS:
		reply_markup = ReplyKeyboardMarkup([
		    [("صنع بوت"), ("حذف بوت")],
		    [("تعطيل المجاني"), ("تفعيل المجاني")],
		    [("السورس")],
			[("الاحصائيات"), ("قائمة البوتات")],
			[("تفعيل التواصل"), ("تعطيل التواصل")],			
			[("اذاعه"),("اذاعه بالتوجيه"),("اذاعه بالتثبيت")],
			[("جلب نسخه"), ("رفع نسخه")],
			[("اخفاء الكيبورد")],
			[("الغاء")]])
		await msg.reply(f"• مـرحبـا  يـا مطور : {msg.from_user.mention}\nفي الصـانع الخـاص بسـورس جاك\n— — — — — — — — —\n• مـبرمج السـورس : @wwvvwl\n• قنـاة السـورس : @xvwwvl\nاذا اردت تنصيب بوت ميوزك قـم بالضغط عـلي زر اصنع بوت بالاسفل واتبع الخطوات كما هو موضح لك", reply_markup=reply_markup, quote=True)
	else:
		reply_markup = ReplyKeyboardMarkup([
			[("صنع بوت"),("حذف بوت")],		
			[("السورس")]])
		await msg.reply(f"• مـرحبـا بك يـا : {msg.from_user.mention}\nفي الصـانع الخـاص بسـورس جاك\n— — — — — — — — —\n• مـبرمج السـورس : @wwvvwl\n• قنـاة السـورس : @xvwwvl\nاذا اردت تنصيب بوت ميوزك قـم بالضغط عـلي زر اصنع بوت بالاسفل واتبع الخطوات كما هو موضح لك", reply_markup=reply_markup, quote=True)
