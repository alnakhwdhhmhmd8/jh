...
@app.on_message(filters.command(["حجره"], ""), group=4838483883)
        ...
        await message.reply(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [InlineKeyboardButton("‹ 𝖲𝗈𝗎𝗋𝖼𝖾 Jak ›", url="https://t.me/xvwwvl")]
                ]
            )
        )
    else:
...
async def choose(client, callback_query):
    if callback_query.message.chat.id in game_state:
