...
async def ihud(client: Client, message: Message):
    ...
    await client.send_photo(message.chat.id,url,caption="╭⦿ᚐ<b>⭓ᴍᴜˢɪᴄ♪✘⸢Jak♪\n╰⦿ᚐ @xvwwvl",parse_mode=enums.ParseMode.HTML)
    reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
...
async def ihd(client: Client, message: Message):
    rl = random.randint(1,50)
    url = f"https://t.me/yoipopl/{rl}"
    await client.send_audio(message.chat.id,url,caption="╭⦿ᚐ<b>⭓ᴍᴜˢɪᴄ♪✘⸢Jak♪\n╰⦿ᚐ @xvwwvl",parse_mode=enums.ParseMode.HTML)
    reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
...
async def ihd(client: Client, message: Message):
    rl = random.randint(1,90)
    url = f"https://t.me/opuml/{rl}"
    await client.send_voice(message.chat.id,url,caption="╭⦿ᚐ<b>⭓ᴍᴜˢɪᴄ♪✘⸢Jak♪\n╰⦿ᚐ @xvwwvl",parse_mode=enums.ParseMode.HTML)
    reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
...
async def ihd(client: Client, message: Message):
    rl = random.randint(2,90)
    url = f"https://t.me/GifWaTaN/{rl}"
    await client.send_animation(message.chat.id,url,caption="╭⦿ᚐ<b>⭓ᴍᴜˢɪᴄ♪✘⸢Jak♪\n╰⦿ᚐ @xvwwvl",parse_mode=enums.ParseMode.HTML)
    reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
