"""
        [InlineKeyboardButton("‹ 𝖡𝖺𝖼𝗄 ›", callback_data="Yrw1 " + str(m.from_user.id))],
        [InlineKeyboardButton("➡️ التالي", callback_data="Yrw3 " + str(m.from_user.id))],
        [InlineKeyboardButton("𝖧𝗈𝗆𝖾", callback_data="moslsl " + str(m.from_user.id))],
        [InlineKeyboardButton("‹ 𝖲𝗈𝗎𝗋𝖼𝖾 xvwwvl›", url=f"https://t.me/xvwwvl")],
"""
...
from VeRoNlMusic import app



@app.on_message(filters.command(["افلام","1افلام"], ""))
...
async def film(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("𝖧𝗈𝗆𝖾", callback_data="aflamAR2 " + str(m.from_user.id))],
        [InlineKeyboardButton("‹ 𝖲𝗈𝗎𝗋𝖼𝖾 xvwwvl›", url=f"https://t.me/xvwwvl")],
...
async def comedy(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("𝖧𝗈𝗆𝖾", callback_data="film " + str(m.from_user.id))],
        [InlineKeyboardButton("‹ 𝖲𝗈𝗎𝗋𝖼𝖾 xvwwvl›", url=f"https://t.me/xvwwvl")],
...
async def Xco1(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("‹ 𝖡𝖺𝖼𝗄 ›", callback_data="comedy " + str(m.from_user.id))],
    ])
...
async def Xact1(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("‹ 𝖡𝖺𝖼𝗄 ›", callback_data="action " + str(m.from_user.id))],
    ])
...
async def Xdra1(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("‹ 𝖡𝖺𝖼𝗄 ›", callback_data="drama " + str(m.from_user.id))],
    ])
...
async def Xms1(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("𝖧𝗈𝗆𝖾", callback_data="msrahia " + str(m.from_user.id))],
        [InlineKeyboardButton("‹ 𝖲𝗈𝗎𝗋𝖼𝖾 xvwwvl›", url=f"https://t.me/xvwwvl")],
        [InlineKeyboardButton("ضيـف البـوت لمجمـوعتـك ✅", url=f"https://t.me/{app.username}?startgroup=new")],
...
async def Xmsrh1(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("𝖧𝗈𝗆𝖾", callback_data="Xms1 " + str(m.from_user.id))],
        [InlineKeyboardButton("‹ 𝖲𝗈𝗎𝗋𝖼𝖾 xvwwvl›", url=f"https://t.me/xvwwvl")],
        [InlineKeyboardButton("ضيـف البـوت لمجمـوعتـك ✅", url=f"https://t.me/{app.username}?startgroup=new")],
